...
export const Input = (props: InputProps) => {
    ...
    return (
        <div className={`${width || "w-65"} justify-self-center ${className}`} >
            ...
            <div className={`pl-4 pr-[10px] py-2 rounded-full border-1 ${error ? 'border-red-700' : 'border-gray-300'}`}>
                <div className="flex flex-row">
                    ...
                    <input
                        ...
                        readOnly={readOnly}
                        onFocus={onFocus}
                        className="pl-[5px] grow color-black outline-0 bg-white fill-white text-sm"
                    />
